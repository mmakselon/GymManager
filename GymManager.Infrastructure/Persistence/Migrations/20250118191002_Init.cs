    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod promocyjny na suplementy w sklepie abc = rabat12." },
                    { 2, new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "W najbliższą niedzielę siłownia jest otwarta do godsziny 24:00." },
                    { 3, new DateTime(2025, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jutrzejsze zajęcia crossfit zostały odwołane - przepraszamy." },
                    { 4, new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Zatrudnimy trenera personalnego." },
                    { 5, new DateTime(2025, 1, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Od przyszłego miesiąca możesz kupić karnet dla dwóch osób w cenie jednego." },
                    { 6, new DateTime(2024, 12, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Zatrudnimy recepcjonistę." },
                    { 7, new DateTime(2024, 12, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod promocyjny na suplementy w sklepie abc = rabat12." },
                    { 8, new DateTime(2024, 12, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "W poprzednim miesiącu zrobiłeś aż 12 treningów - gratulacje." },
                    { 9, new DateTime(2024, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jutrzejsze zajęcia crossfit zostały odwołane - przepraszamy." },
                    { 10, new DateTime(2024, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kod promocyjny na suplementy w sklepie abc = rabat12." },
                    { 11, new DateTime(2024, 12, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Odbierz kod zniżkowy na suplementacje w recepcji." },
                    { 12, new DateTime(2024, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Wesołych świąt." }
                });
